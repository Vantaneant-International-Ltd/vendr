...
<style>
	...
	/* Helps legibility without making everything flat */
	.vignette {
		position: absolute;
		inset: 0;
		z-index: 3;
...
<main class="wrap">
	<h1>Privacy</h1>
	<p>
		Vendr respects your privacy. This site does not use a newsletter form by default.
		If you contact us by email, we will only use your message to respond to your enquiry.
	</p>
	<p class="fine">Last updated: {new Date().toISOString().slice(0, 10)}</p>
</main>
...
<main class="wrap">
	<h1>Terms</h1>
	<p>
		This website is provided for informational purposes. Details on products, services, and launch
...
<main class="wrap">
	<h1>Legal</h1>
	<p>
		Vendr is a subsidiary of VNTA (Vantanéant International). For enquiries, contact
		<a href="mailto:hello@vendr.ie">hello@vendr.ie</a>.
	</p>
	<p>
		If/when applicable, company registration details (registered office, CRO/VAT numbers) will be
		listed here.
	</p>
	<p class="fine">Last updated: {new Date().toISOString().slice(0, 10)}</p>
</main>
