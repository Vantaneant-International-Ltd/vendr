...
<main id="top">
	...
	<section class="band" aria-label="Vendr in space">
		...
		<div class="wrap band-in">
			...
			<span class="band-mark" data-reveal><Wordmark src="/wordmark.png" size={20} /></span>
		</div>
	</section>
...
<style>
	...
	.band-img {
		...
		filter: brightness(0.46) saturate(0.82) contrast(1.05);
	}
	.band-veil {
		position: absolute;
		inset: 0;
