<script>
	// STATE: maintenance — dark cinematic holding page, matching Coming Soon.
	// Mono technical, the "\" motif, monochrome. (A true 503 needs a server.)
...
<main class="mt">
	...
	<footer class="bar bottom">
		<span class="tag">{brand.legalEntity} · Est. {brand.established}</span>
	</footer>
</main>
